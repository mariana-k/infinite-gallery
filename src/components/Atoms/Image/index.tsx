...
const Image: FC<ImageProps> = ({ src, altText }) => {
  ...
  return (
    <StyledImage ref={imgElement} data-height={imgElement ? imgElement.current ? imgElement.current.naturalHeight: 0 : 0} data-width={width} className='card-img-top mm-masonry__img' src={imagePlaceholder} alt={altText} data-src={src} />
  )
}
