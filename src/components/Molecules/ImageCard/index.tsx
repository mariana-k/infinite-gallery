...
const ImageCard: FC<ImageCardProps> = ({ image, description }) => {
  ...
  return (
    <StyledImageCardWrapper className="mm-masonry__item" cardHeight={handleImageCardHeight(ref ? ref.current ? Number(ref.current.children[0].getAttribute('data-height')) : 0 : 0)}
